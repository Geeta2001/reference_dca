...
public class DeveloperController {
	...
	public ResponseEntity<String> editDeveloper(@PathVariable("devId") int devId, @RequestBody DeveloperDTO developerdto) {
	...
	public ResponseEntity<String> editResponse(@PathVariable("respId") int respId,@RequestBody ResponseDTO responsedto) {
