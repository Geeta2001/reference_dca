...
public class DeveloperServiceImpl implements DeveloperService {
	...
	@SuppressWarnings("deprecation")
	@Override
	public ResponseEntity<Developer> blockDeveloper(DeveloperDTO developerdto, int devId) {
		// TODO Auto-generated method stub
		Developer getDev = developerRepository.getById(devId);
	...
	@SuppressWarnings("deprecation")
	@Override
	public ResponseEntity<Developer> unblockDeveloper(DeveloperDTO developerdto, int devId) {
		// TODO Auto-generated method stub
		Developer getDev = developerRepository.getById(devId);
