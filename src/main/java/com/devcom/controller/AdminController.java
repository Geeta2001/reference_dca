...
public class AdminController {
	...
	public ResponseEntity<Developer> blockDeveloper(@PathVariable("devId") int devId, @RequestBody DeveloperDTO developerdto) {
		return this.developerService.blockDeveloper(developerdto,devId);
	}
	
	@PutMapping("/unblockdeveloper/{devId}")
	public ResponseEntity<Developer> unblockDeveloper(@PathVariable("devId") int devId, @RequestBody DeveloperDTO developerdto) {
